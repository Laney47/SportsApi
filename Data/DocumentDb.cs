    ...
    public class DocumentDb
    {
        ...
        protected static DocumentClient Client
        {
            get
            {
                if (_client == null)
                {
                   const string endpoint = "https://sensordataproj.documents.azure.com:443/";
                    const string authKey = "NGE3L1BrcnD1Mgj848VXPG4zIX9jeZwv4iv5dy6MgD6wriFdVALXaCdnIgLDWgxMw9mE1mL0hGjQ1pIEQWIElw==";
